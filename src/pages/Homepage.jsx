    ...
    <Layout>
        ...
        <div className='w-full h-full flex justify-between'>
          ...
          <div className='flex flex-col w-[720px] justify-center gap-12'>
            ...
            <div className='flex flex-col gap-6'>
              <h1 className='text-xl font-semibold text-primary'>{CONTENT.homepage.about.title}</h1>
              <h2 className='text-5xl font-semibold text-primary'>{CONTENT.homepage.about.subtitle}</h2>
            </div>
            {/* Description Content */}
          ...
          <div className='w-xl relative'>
            ...
            <div className='absolute right-0 top-8 w-[450px] h-[350px] rounded-4xl overflow-hidden'>
              <img src={ASSETS.homepage.about.contentImage1} alt="About Content Image 1" className='object-cover h-full'/>
            </div>

            {/* Second Image */}
            <div className='absolute left- 0 bottom-8 w-[450px] h-[350px] rounded-4xl overflow-hidden'>
              <img src={ASSETS.homepage.about.contentImage2} alt="About Content Image 2" className='object-cover h-full'/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className='min-h-screen flex flex-col px-36 py-24 bg-secondary gap-12'>
        ...
        <div className='flex flex-col items-center h-full gap-8'>
          <h1 className='text-xl font-semibold text-primary'>{CONTENT.homepage.services.title}</h1>
          <h2 className='text-5xl font-semibold text-primary'>{CONTENT.homepage.services.subtitle}</h2>
          <p className='text-center text-primary'>{CONTENT.homepage.services.description}</p>
        </div>
      ...
      <section className='min-h-screen flex gap-16 px-36 py-24 relative items-center'>
          ...
          <div className='flex flex-col relative w-[550px] h-[728px] bg-primary/65 rounded-lg overflow-hidden p-12 gap-8'>
            ...
            <p className='text-secondary'>{CONTENT.homepage.workflow.description}</p>
          </div>
          ...
          <div className='flex flex-col w-[940px] h-[728px] justify-between'>
            <div className='flex w-full text-secondary gap-10'>
              <div className='flex flex-col gap-3'>
                <p className='text-xl'>{CONTENT.homepage.workflow.workflowCard[0].no}</p>
                <h3 className='text-4xl'>{CONTENT.homepage.workflow.workflowCard[0].flowName}</h3>
                <p>{CONTENT.homepage.workflow.workflowCard[0].flowDescription}</p>
              </div>

              <div className='flex flex-col gap-3'>
                <p className='text-xl'>{CONTENT.homepage.workflow.workflowCard[1].no}</p>
                <h3 className='text-4xl'>{CONTENT.homepage.workflow.workflowCard[1].flowName}</h3>
            ...
            <div className='flex w-full text-secondary gap-10'>
              <div className='flex flex-col gap-3'>
                <p className='text-xl'>{CONTENT.homepage.workflow.workflowCard[2].no}</p>
                <h3 className='text-4xl'>{CONTENT.homepage.workflow.workflowCard[2].flowName}</h3>
                <p>{CONTENT.homepage.workflow.workflowCard[2].flowDescription}</p>
              </div>

              <div className='flex flex-col gap-3'>
                <p className='text-xl'>{CONTENT.homepage.workflow.workflowCard[3].no}</p>
                <h3 className='text-4xl'>{CONTENT.homepage.workflow.workflowCard[3].flowName}</h3>
            ...
            <div className='flex w-full text-secondary gap-10'>
              <div className='flex flex-col gap-3'>
                <p className='text-xl'>{CONTENT.homepage.workflow.workflowCard[4].no}</p>
                <h3 className='text-4xl'>{CONTENT.homepage.workflow.workflowCard[4].flowName}</h3>
      ...
      <section className='min-h-screen flex flex-col gap-16 px-36 py-24 items-center bg-secondary'>
        ...
        <div className='flex flex-col w-full gap-6 items-center text-primary'>
          <h1 className='text-xl font-semibold'>{CONTENT.homepage.portfolio.title}</h1>
          <h2 className='text-5xl font-semibold'>{CONTENT.homepage.portfolio.subtitle}</h2>
          <p className='text-center'>{CONTENT.homepage.portfolio.description}</p>
        </div>
        ...
        <div className='flex gap-10 h-140 w-full'>
          ...
          <div className='flex items-end h-full w-2/5 relative p-8 overflow-hidden rounded-lg'>
            ...
            <div className='z-1 text-secondary flex flex-col gap-2'>
              <p className='text-xl font-semibold'>{CONTENT.homepage.portfolio.portfolioCard[0].portfolioTitle}</p>
              <p className='text-sm'>{CONTENT.homepage.portfolio.portfolioCard[0].portfolioLocation}</p>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-10 h-full w-3/5 '>
            <div className='flex w-full flex-1 gap-10'>
              ...
              <div className='flex items-end flex-1 relative overflow-hidden p-8 rounded-lg'>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent" />
                <div className='z-1 text-secondary flex flex-col gap-2'>
                  <p className='text-xl font-semibold'>{CONTENT.homepage.portfolio.portfolioCard[1].portfolioTitle}</p>
                  <p className='text-sm'>{CONTENT.homepage.portfolio.portfolioCard[1].portfolioLocation}</p>
                </div>
              </div>
              ...
              <div className='flex items-end flex-1 relative p-8 overflow-hidden rounded-lg'>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent" />
                <div className='z-1 text-secondary flex flex-col gap-2'>
                  <p className='text-xl font-semibold'>{CONTENT.homepage.portfolio.portfolioCard[2].portfolioTitle}</p>
                  <p className='text-sm'>{CONTENT.homepage.portfolio.portfolioCard[2].portfolioLocation}</p>
                </div>
              </div>
            </div>
            ...
            <di className='flex items-end flex-1 relative p-8 overflow-hidden rounded-lg'>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent" />
              <div className='z-1 text-secondary flex flex-col gap-2'>
                <p className='text-xl font-semibold'>{CONTENT.homepage.portfolio.portfolioCard[3].portfolioTitle}</p>
                <p className='text-sm'>{CONTENT.homepage.portfolio.portfolioCard[3].portfolioLocation}</p>
              </div>
            </di>
          </div>
        </div>
      ...
      <section className='min-h-[600px] flex flex-col gap-12 px-36 py-24 items-center bg-secondary text-primary'>
        <div className='flex flex-col items-center gap-4'>
          <h2 className='text-5xl font-semibold'>{CONTENT.homepage.testimonials.title}</h2>
          <p className='text-sm'>{CONTENT.homepage.testimonials.subtitle}</p>
        </div>
        <TestimonialCarousel />
      </section>
    </Layout>
